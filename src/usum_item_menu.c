...
static const u32 sHoverSlot_Gfx[]               = INCGFX_U32("graphics/bag/usum/hover_slot.png", ".4bpp.smol");
...
static const u32 sPocketScrollArrows_Gfx[]      = INCGFX_U32("graphics/bag/usum/pocket_scroll_arrows.png", ".4bpp.smol");
