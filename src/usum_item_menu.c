...
static const u32 sCategoryIcons_Gfx[]           = INCGFX_U32("graphics/bag/usum/category_icons.png", ".4bpp.smol");
...
#if USUM_ITEM_MENU_IN_BAG_USE && USUM_ITEM_MENU_IN_BATTLE_USE
