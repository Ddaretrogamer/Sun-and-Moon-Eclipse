...
const u8 gText_ThisIsAPokemon[] = _("Such mysterious creatures!”{PAUSE 96}\p");
...
// const u8 gText_ColorDynamic6WhiteDynamic5[] = _("{BACKGROUND WHITE}{TEXT_COLORS DYNAMIC_COLOR6 DYNAMIC_COLOR5 WHITE}"); // from master, decide which to keep.
...
const u8 gText_CutsceneSkipNoSkip[] = _("NO SKIP");
const u8 gText_CutsceneSkipButton[] = _("SKIP BUTTON");
...
const u8 gText_Melemele[] = _("MELEMELE");
