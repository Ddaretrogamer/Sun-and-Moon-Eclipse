...
static const u8 sDoorAnimTiles_AlolaPokecenter[] = INCGFX_U8("graphics/door_anims/alolapokecenter.png", ".4bpp");
static const u8 sDoorAnimTiles_PlayerHouse[] = INCGFX_U8("graphics/door_anims/playerhouse.png", ".4bpp");
static const u8 sDoorAnimTiles_TrainerSchool[] = INCGFX_U8("graphics/door_anims/trainerschool.png", ".4bpp");
static const u8 sDoorAnimTiles_HauoliLab[] = INCGFX_U8("graphics/door_anims/hauolilab.png", ".4bpp");
static const u8 sDoorAnimTiles_IkiTownHouse[] = INCGFX_U8("graphics/door_anims/ikitownhouse.png", ".4bpp");
static const u8 sDoorAnimTiles_IkiTownSlideRight[] = INCGFX_U8("graphics/door_anims/ikitownslideright.png", ".4bpp");
static const u8 sDoorAnimTiles_IkiTownSlideLeft[] = INCGFX_U8("graphics/door_anims/ikitownslideleft.png", ".4bpp");
static const u8 sDoorAnimTiles_Route2Door[] = INCGFX_U8("graphics/door_anims/Route2Door1.png", ".4bpp");
static const u8 sDoorAnimTiles_SlakingDoor1[] = INCGFX_U8("graphics/door_anims/slakinghotel1.png", ".4bpp");
static const u8 sDoorAnimTiles_SlakingDoor2[] = INCGFX_U8("graphics/door_anims/slakinghotel21.png", ".4bpp");
static const u8 sDoorAnimTiles_HauoliDeptStoreLeft[] = INCGFX_U8("graphics/door_anims/hauoliskyscraperleft1.png", ".4bpp");
static const u8 sDoorAnimTiles_HauoliDeptStoreRight[] = INCGFX_U8("graphics/door_anims/hauoliskyscraperright1.png", ".4bpp");
static const u8 sDoorAnimTiles_HauoliDeptStoreDoor[] = INCGFX_U8("graphics/door_anims/hauolideptstore1.png", ".4bpp");
static const u8 sDoorAnimTiles_LeavannyDoor[] = INCGFX_U8("graphics/door_anims/leavanny1.png", ".4bpp");
static const u8 sDoorAnimTiles_HaouliWeatherLeft[] = INCGFX_U8("graphics/door_anims/weatherleft1.png", ".4bpp");
static const u8 sDoorAnimTiles_HaouliWeatherRight[] = INCGFX_U8("graphics/door_anims/weatherright1.png", ".4bpp");
static const u8 sDoorAnimTiles_HauoliWhiteHouseDoor[] = INCGFX_U8("graphics/door_anims/hauoliwhitehouse1.png", ".4bpp");
static const u8 sDoorAnimTiles_CandyShopDoor[] = INCGFX_U8("graphics/door_anims/candyshop1.png", ".4bpp");
static const u8 sDoorAnimTiles_PoliceDoorLeft[] = INCGFX_U8("graphics/door_anims/policestationleft1.png", ".4bpp");
static const u8 sDoorAnimTiles_PoliceDoorRight[] = INCGFX_U8("graphics/door_anims/policestationright1.png", ".4bpp");
static const u8 sDoorAnimTiles_HaouliDockRight[] = INCGFX_U8("graphics/door_anims/dockright1.png", ".4bpp");
static const u8 sDoorAnimTiles_HaouliDockLeft[] = INCGFX_U8("graphics/door_anims/dockleft1.png", ".4bpp");
static const u8 sDoorAnimTiles_PlayerHouse_Door[] = INCGFX_U8("graphics/door_anims/alolahousedoor.png", ".4bpp");
static const u8 sDoorAnimTiles_Building[] = INCGFX_U8("graphics/door_anims/building_yellow_door.png", ".4bpp");
...
static const u8 sDoorAnimPalettes_Building[] = {6, 6, 6, 6, 9, 9, 9, 9};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    /// check these tilesets
    {METATILE_AlolaPokecenter_Door,                         &gTileset_orangeislands, DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_AlolaPokecenter, sDoorAnimPalettes_AlolaPokecenter},
    {METATILE_PlayerHouse_Door,                             &gTileset_orangeislands, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_PlayerHouse, sDoorAnimPalettes_PlayerHouse},
    {METATILE_TrainerSchool_Door,                           &gTileset_orangeislands, DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_TrainerSchool, sDoorAnimPalettes_TrainerSchool},
    {METATILE_HauoliLab_Door,                               &gTileset_orangeislands, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_HauoliLab, sDoorAnimPalettes_HauliLab},
    {METATILE_IkiTownHouse_Door,                            &gTileset_IkiTown, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_IkiTownHouse, sDoorAnimPalettes_IkiTownHouse},
    {METATILE_IkiTownSlide_Right,                           &gTileset_IkiTown, DOOR_SOUND_ARENA, 1, sDoorAnimTiles_IkiTownSlideRight, sDoorAnimPalettes_IkiTownSlideRight},
    {METATILE_IkiTownSlide_Left,                            &gTileset_IkiTown, DOOR_SOUND_ARENA, 1, sDoorAnimTiles_IkiTownSlideLeft, sDoorAnimPalettes_IkiTownSlideLeft},
    {METATILE_Route2_Door,                                  &gTileset_Route2tiles, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_Route2Door, sDoorAnimPalettes_Route2Door},
    {METATILE_Slaking_Door1,                                &gTileset_Route2tiles, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_SlakingDoor1, sDoorAnimPalettes_SlakingDoor1},
    {METATILE_Slaking_Door2,                                &gTileset_Route2tiles, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_SlakingDoor2, sDoorAnimPalettes_SlakingDoor2},
    {METATILE_DeptStore_Left,                               &gTileset_HauoliCity, DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_HauoliDeptStoreLeft, sDoorAnimPalettes_HauoliDeptStoreLeft},
    {METATILE_DeptStore_Right,                              &gTileset_HauoliCity, DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_HauoliDeptStoreRight, sDoorAnimPalettes_HauoliDeptStoreRight},   
    {METATILE_Clothing_Door,                                &gTileset_HauoliCity, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_HauoliDeptStoreDoor, sDoorAnimPalettes_HauoliDeptStoreDoor},
    {METATILE_Leavanny_Door,                                &gTileset_HauoliCity, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_LeavannyDoor, sDoorAnimPalettes_LeavannyDoor},
    {METATILE_Weather_Left,                                 &gTileset_HauliCity_South, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_HaouliWeatherLeft, sDoorAnimPalettes_HaouliWeatherLeft},
    {METATILE_Weather_Right,                                &gTileset_HauliCity_South, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_HaouliWeatherRight, sDoorAnimPalettes_HaouliWeatherRight},
    {METATILE_WhiteHouse_Door,                              &gTileset_HauliCity_South, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_HauoliWhiteHouseDoor, sDoorAnimPalettes_HauoliWhiteHouseDoor},
    {METATILE_CandyShop_Door,                               &gTileset_HauliCity_South, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_CandyShopDoor, sDoorAnimPalettes_CandyShopDoor},
    {METATILE_Police_Left,                                  &gTileset_HauliCity_South, DOOR_SOUND_NORMAL, 1, sDoorAnimTiles_PoliceDoorLeft, sDoorAnimPalettes_PoliceDoorLeft},
