...
const u16 gFemaleBagPalette[] = INCGFX_U16("graphics/bag/bag_female.pal", ".gbapal");
...
const u16 gBattleIcons_Pal1[] = INCGFX_U16("graphics/types/battle_icons1.png", ".gbapal");
const u16 gBattleIcons_Pal2[] = INCGFX_U16("graphics/types/battle_icons2.png", ".gbapal");
