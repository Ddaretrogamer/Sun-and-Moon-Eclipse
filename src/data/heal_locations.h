static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ROUTE1 - 1] = {MAP_GROUP(ROUTE1), MAP_NUM(ROUTE1), 16, 21},
    [HEAL_LOCATION_IKI_TOWN - 1] = {MAP_GROUP(IKI_TOWN), MAP_NUM(IKI_TOWN), 11, 13},
    [HEAL_LOCATION_HAUOLI_CITY - 1] = {MAP_GROUP(HAUOLI_CITY), MAP_NUM(HAUOLI_CITY), 15, 18},
    [HEAL_LOCATION_HAUOLI_CITY_DOCK - 1] = {MAP_GROUP(HAUOLI_CITY_DOCK), MAP_NUM(HAUOLI_CITY_DOCK), 30, 22},
};
