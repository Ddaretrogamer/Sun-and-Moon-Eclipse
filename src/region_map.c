...
static const u16 sRegionMapBg_Pal[] = INCGFX_U16("graphics/pokenav/region_map/map_melemele.pal", ".gbapal");
static const u32 sRegionMapBg_GfxLZ[] = INCGFX_U32("graphics/pokenav/region_map/map_melemele.png", ".8bpp.smol");
static const u32 sRegionMapBg_TilemapLZ[] = INCBIN_U32("graphics/pokenav/region_map/map_melemele.bin.smolTM");
static const u16 sRegionMapPlayerIcon_ElioPal[] = INCGFX_U16("graphics/pokenav/region_map/elio_icon.png", ".gbapal");
static const u8 sRegionMapPlayerIcon_ElioGfx[] = INCGFX_U8("graphics/pokenav/region_map/elio_icon.png", ".4bpp");
static const u16 sRegionMapPlayerIcon_SelenePal[] = INCGFX_U16("graphics/pokenav/region_map/selene_icon.png", ".gbapal");
static const u8 sRegionMapPlayerIcon_SeleneGfx[] = INCGFX_U8("graphics/pokenav/region_map/selene_icon.png", ".4bpp");
...
#include "data/region_map/region_map_layout_alola.h"
...
{
    u8 spriteId;
    struct SpriteSheet sheet = {sRegionMapPlayerIcon_ElioGfx, 0x80, tileTag};
    struct SpritePalette palette = {sRegionMapPlayerIcon_ElioPal, paletteTag};
