...
extern const u16 gFemaleBagPalette[];
...
extern const u32 gNamingScreenTextEntryBox_Left_Gfx[];
extern const u32 gNamingScreenTextEntryBox_Mid_Gfx[];
extern const u32 gNamingScreenTextEntryBox_Right_Gfx[];
