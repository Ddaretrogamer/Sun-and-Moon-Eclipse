...
#define WE_FLAG_NO_ENCOUNTER        FLAG_OW_NO_ENCOUNTER      // If this flag is set, wild encounters will be disabled.
...
#define WE_FLAG_NO_CATCHING          FLAG_NO_WILD_CATCHING     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define WE_FLAG_NO_RUNNING           FLAG_NO_WILD_RUNNING     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
...
#define WE_OWE_FLAG_DISABLED                    FLAG_OW_MON_SPAWN        // Replace 0 with a flag to use it to enable/disable generated OWEs.
