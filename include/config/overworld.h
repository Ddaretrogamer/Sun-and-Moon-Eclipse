...
// Map pop-up config
#define OW_POPUP_GENERATION        GEN_7    // Different generations display location names in overworld pop-ups differently.
                                            // Only choices are GEN_3, GEN_5 and GEN_7, all others will default to Gen3 pop-ups.
