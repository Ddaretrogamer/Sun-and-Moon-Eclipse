...
#define EMU_PASSES_IGNITED_IOS      (EMU_CHECK_REG_IMC | EMU_CHECK_TIMER_CASCADE | EMU_CHECK_SOUNDCNT_H | EMU_CHECK_KEYCNT | EMU_CHECK_SOUNDCNT_L)
// clang-format on
...
// define the text strings to show in the error message for recommended emulators
 ...
 #define VIABLE_MGBA_RA_ANDROID "\n- RetroArch (Android, core: mGBA)"
#else
 #define VIABLE_MGBA_RA_ANDROID ""
#endif

#if EMU_VIABLE(EMU_PASSES_IGNITED_IOS)
 #define VIABLE_IGNITED_IOS     "\n- Ignited (iOS)"
#else
 #define VIABLE_IGNITED_IOS     ""
#endif
