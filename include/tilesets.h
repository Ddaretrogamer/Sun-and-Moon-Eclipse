...
extern const struct Tileset gTileset_IkiTown;
extern const struct Tileset gTileset_Route2tiles;
extern const struct Tileset gTileset_orangeislands;
extern const struct Tileset gTileset_HauoliCity_Primary;
