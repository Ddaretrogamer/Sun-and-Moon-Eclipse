...
enum
{
    ...
    OBJ_EVENT_GFX_ALOLA_ACE_M,
    OBJ_EVENT_GFX_ALOLA_ACE_F,
    OBJ_EVENT_GFX_GLADION,
    OBJ_EVENT_GFX_LILLIE_HAT,
    OBJ_EVENT_GFX_TEAM_SKULL_GRUNT_M,
    OBJ_EVENT_GFX_TEAM_SKULL_GRUNT_F,
    OBJ_EVENT_GFX_LUSAMINE,
    OBJ_EVENT_GFX_AETHER_GRUNT_M,
    OBJ_EVENT_GFX_AETHER_GRUNT_F,
    OBJ_EVENT_GFX_HALA,
    OBJ_EVENT_GFX_ILIMA,
    OBJ_EVENT_GFX_KIAWE,
    OBJ_EVENT_GFX_KUKUI,
    OBJ_EVENT_GFX_LILLIE,
    OBJ_EVENT_GFX_ELIO_NORMAL,
    OBJ_EVENT_GFX_SELENE_NORMAL,
    OBJ_EVENT_GFX_ELIO_RIDING,
    OBJ_EVENT_GFX_SELENE_RIDING,
    OBJ_EVENT_GFX_HAU,
    OBJ_EVENT_GFX_MINA,
    OBJ_EVENT_GFX_LANA,
    OBJ_EVENT_GFX_ULTRA_RECON_1,
    OBJ_EVENT_GFX_ULTRA_RECON_2,
    OBJ_EVENT_GFX_ULTRA_RECON_3,
    OBJ_EVENT_GFX_ULTRA_RECON_4,
...
#define OBJ_EVENT_PAL_TAG_ULTRA_RECON_1           0x1146
#define OBJ_EVENT_PAL_TAG_ULTRA_RECON_2           0x1147
#define OBJ_EVENT_PAL_TAG_ULTRA_RECON_3           0x1148
#define OBJ_EVENT_PAL_TAG_ULTRA_RECON_4           0x1149
#define OBJ_EVENT_PAL_TAG_SAMSON_OAK              0x114A
#define OBJ_EVENT_PAL_TAG_ILIMA                   0x114B
