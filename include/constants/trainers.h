...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_KIAWE,
    TRAINER_PIC_FRONT_HAU,
    TRAINER_PIC_FRONT_GUZMA,
    TRAINER_PIC_FRONT_GLADION,
    TRAINER_PIC_FRONT_KUKUI,
    TRAINER_PIC_FRONT_ILIMA,
    TRAINER_PIC_FRONT_HALA,
    TRAINER_PIC_FRONT_SKULL_GRUNT_M,
    TRAINER_PIC_FRONT_SKULL_GRUNT_F,
    TRAINER_PIC_FRONT_ALOLA_ACE_M,
