...
enum ScrOp
{
    ...
    SCR_OP_SETSPEAKER = 0xE5,
    SCR_OP_TRANSFORM = 0xE6,
    SCR_OP_HIDEFOLLOWER = 0xE7,
    SCR_OP_GETBRAILLESTRINGWIDTH = 0xE8,
    SCR_OP_LOCKPLAYER = 0xE9,
    SCR_OP_RELEASEPLAYER = 0xEA,
    SCR_OP_QUESTMENU = 0xEB,
    SCR_OP_SUBQUESTMENU = 0xEC,
    SCR_OP_RETURNQUESTSTATE = 0xED,
    SCR_OP_ROTOMMENUSHOW = 0xEE,
};
